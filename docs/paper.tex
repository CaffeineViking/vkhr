...
\usepackage[pdftex, hidelinks,
            pdftitle={Real-Time Hair Renderer in Vulkan},
            pdfauthor={Erik Sven Vasconcelos Jansson},
            pdfsubject={Computer Graphics -- Rendering},
            pdfkeywords={real-time, hair, rendering, vulkan,
                         liu, tum, amd, frostbite}]{hyperref}
