...
<p align="center">
   ...
   <br>
   The screenshot above is another render from the TressFX Ponytail (with 136,320 strands of hair), but from a different angle.
</p>

<p align="center">
   <img src="/docs/figures/bear.jpg"     alt="Bear from TressFX"/>
   <img src="/docs/figures/bear-fur.jpg" alt="Enhanced Fur for Bear"/>
   <br>
   Above are screenshots of the TressFX Bear (with 961,280 strands of fur and 3,845,120 line segments) rendered in real-time.
</p>
